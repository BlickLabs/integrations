...
SIC_CO_QUOTE_MAILGUN_DOMAIN = env('SIC_CO_QUOTE_MAILGUN_DOMAIN', default='CHANGEME!!!')
SIC_CO_QUOTE_MAILGUN_RECIPIENT = env('SIC_CO_QUOTE_MAILGUN_RECIPIENT', default='CHANGEME!!!')

SIC_ARG_MAILGUN_DOMAIN = env('SIC_ARG_MAILGUN_DOMAIN', default='CHANGEME!!!')
SIC_ARG_MAILGUN_RECIPIENT = env('SIC_ARG_MAILGUN_RECIPIENT', default='CHANGEME!!!')

SIC_ARG_QUOTE_MAILGUN_DOMAIN = env('SIC_ARG_QUOTE_MAILGUN_DOMAIN', default='CHANGEME!!!')
SIC_ARG_QUOTE_MAILGUN_RECIPIENT = env('SIC_ARG_QUOTE_MAILGUN_RECIPIENT', default='CHANGEME!!!')

CAMPOSYCAMPOS_MAILGUN_DOMAIN = env('CAMPOSYCAMPOS_MAILGUN_DOMAIN', default='CHANGEME!!!')
CAMPOSYCAMPOS_MAILGUN_RECIPIENT = env('CAMPOSYCAMPOS_MAILGUN_RECIPIENT', default='CHANGEME!!!')

RIVERSLEGAL_CAREERS_MAILGUN_DOMAIN = env('RIVERSLEGAL_CAREERS_MAILGUN_DOMAIN', default='CHANGEME!!!')
RIVERSLEGAL_CAREERS_MAILGUN_RECIPIENT = env('RIVERSLEGAL_CAREERS_MAILGUN_RECIPIENT', default='CHANGEME!!!')

RIVERSLEGAL_CONTACT_MAILGUN_DOMAIN = env('RIVERSLEGAL_CONTACT_MAILGUN_DOMAIN', default='CHANGEME!!!')
RIVERSLEGAL_CONTACT_MAILGUN_RECIPIENT = env('RIVERSLEGAL_CONTACT_MAILGUN_RECIPIENT', default='CHANGEME!!!')
